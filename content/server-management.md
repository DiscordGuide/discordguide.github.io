...
**"Verification Levels"** these are the levels for being able to send a message, if a user doesn't meet these they cannot send messages in the server. 
...
Limbo Rooms and Limbo Servers are rooms or servers that require a Staff approving you to move past into other rooms, or the rest of the server. Most membership based servers have these so people joining can decide if they will follow the rules or not, and accept the consequences if they break them.
...
**Didn't see something here you wanted? Let us know, check out resources, or maybe the following server guides and maybe you’ll find it!!**

## Running a Server

**Well, hello!** Guess you’re here for more server management tips right?
...
Understanding? This means a lot. Not just understanding what your doing with your server but understanding the members.
...
How is your **Ability** as a Owner? How well is your server setup? How much do you know about the topic it’s based around?
...
_`*`_ Bot to Site lists
   Bot’s that track your server and post your server as an advertisement on a site
_`*`_ Server lists
...
You may be asking, “How does having members make me grow…? Isn’t that the goal?” but, a good server will have members who share it with their friends. One person sharing a server with 10 people, then that person sharing it with 10, etc that’s 100 which can easy keep spreading.
...
If you need anything let us know, and I hope you check out the other guides! 

Maybe you’re a seasoned pro? Always able to talk to us about staff positions!
